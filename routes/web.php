...
use App\Http\Controllers\C_Sakramen;
...
Route::prefix('backyard')->group(function () {
    ...
    Route::middleware('login')->group(function () {
        ...
        Route::get('/sakramen', [C_Sakramen::class, 'index'])->name('sakramen');
        Route::get('/sakramen/create', [C_Sakramen::class, 'create'])->name('sakramenCreate');
        Route::post('/sakramen/store', [C_Sakramen::class, 'store'])->name('sakramenStore');
        Route::get('/sakramen/{id}', [C_Sakramen::class, 'detail'])->name('sakramenDetail');
        Route::post('/sakramen/update/{id}', [C_Sakramen::class, 'update'])->name('sakramenUpdate');
        Route::delete('/sakramen/{id}', [C_Sakramen::class, 'delete'])->name('sakramenDelete');
        Route::get('/sakramen-trash', [C_Sakramen::class, 'trash'])->name('sakramenTrash');
        Route::post('/sakramen/restore/{id}', [C_Sakramen::class, 'restore'])->name('sakramenRestore');
        Route::delete('/sakramen/forceDelete/{id}', [C_Sakramen::class, 'forceDelete'])->name('sakramenForceDelete');
    });
});
