...
@section('title', 'SPWPAB | Update Profile Paroki')
@section('keywords', 'Sistem Pengelolaan Website Paroki Asam Besar, Paroki, Asam Besar, Paroki Asam Besar, Sistem Pengelolaan, Website, SPWPAB, update profile paroki, ubah profile paroki, admin panel')
@section('description', 'Update Profile Paroki - Fitur Mengubah Profile Paroki')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page" style="color: black"><strong>Detail Profile Paroki</strong></li>
    </ol>
</nav>
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <form id="profileForm" action="{{ route('profileUpdate', encrypt($data->id)) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="Contoh: Dewan Pengurus Paroki" required value="{{ $data->title }}">
                            </div>
                            <div class="form-group">
